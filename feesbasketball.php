...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  <p><a href="dashboard.php" class="nothing"><i class="fa fa-long-arrow-left"></i> &nbsp;Admin Dashboard</a></p>
    <a href="feesbasketball.php"class="activ">Basketball</a>
    <a href="feescricket.php">Cricket</a>
  ...
  $sql = "SELECT sid, name, sports, jan, feb, mar, apr, may, jun, july, aug, sep, oct, nov, dece FROM fees_record where sports='Basketball'";
