...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  <aside id="sidebar">
    ...
    <a href="studentbasketball.php" class="activ">Basketball</a>
    <a href="studentcricket.php">Cricket</a>
    <a href="studentrunning.php">Running</a>
  ...
  $sql = "SELECT sid, name, sports, parents, phone, address, dob, slot, coach FROM student where sports='Basketball'";
