...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  <aside id="sidebar">
    ...
    <a href="feesrunning.php"class="activ">Running</a>
  ...
  $sql = "SELECT sid, name, sports, jan, feb, mar, apr, may, jun, july, aug, sep, oct, nov, dece FROM fees_record where sports='Running'";
