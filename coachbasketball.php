...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  $sql = "SELECT tid, tname, sports, email, tphone, taddress, experience FROM coach where sports='Basketball'";
