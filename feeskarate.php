...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  <aside id="sidebar">
    ...
    <a href="feeskarate.php" class="activ">Karate</a>
  ...
  $sql = "SELECT sid, name, sports, jan, feb, mar, apr, may, jun, july, aug, sep, oct, nov, dece FROM fees_record where sports='Karate'";
