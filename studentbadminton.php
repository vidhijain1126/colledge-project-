...
<button id="sidebarToggle" onclick="abc()">☰</button>
  ...
  <aside id="sidebar">
    ...
    <a href="studentbadminton.php" class="activ">Badminton</a>
  ...
  $sql = "SELECT sid, name, sports, parents, phone, address, dob, slot, coach FROM student where sports='Badminton'";
